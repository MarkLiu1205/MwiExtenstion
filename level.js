...
(function () {
    ...
    // 补上繁体中文技能名称对应（游戏依语系显示简体或繁体，攻击/防御/近战/远程的繁简字不同）
    REVERSE_SKILL_MAP["攻擊"] = "/skills/attack";
    REVERSE_SKILL_MAP["防禦"] = "/skills/defense";
    REVERSE_SKILL_MAP["近戰"] = "/skills/melee";
    REVERSE_SKILL_MAP["遠程"] = "/skills/ranged";

    // 已处理的提示框列表，避免重复处理（WeakSet 讓已移除的 tooltip 節點可被回收，不會累積記憶體）
    ...
    function initScript() {
        ...
        const observer = new MutationObserver((mutations) => {
            mutations.forEach(mutation => {
                ...
                // 屬性變動只檢查目標節點本身；新插入的 tooltip 由上面的 childList 分支處理，
                // 不需要對每次 class/style 變動都做整棵子樹的 querySelectorAll
